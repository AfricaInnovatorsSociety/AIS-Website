...
export type LeadershipYear = {
  ...
  label: string;
  /** Sub-label shown under the team grid, e.g. "August 2025 to Present" */
  range: string;
...
export const leadershipYears: LeadershipYear[] = [
  {
    id: "2025-2026",
    label: "2025-26",
    range: "August 2025 to Present · Current Executive Team",
    isCurrent: true,
    team: [
      {
  ...
  },
  {
    id: "2024-2025",
    label: "2024-25",
    range: "Spring 1 2025 to Fall 2025",
    team: [
      {
  ...
  },
  {
    ...
    range: "November 2023 to Spring 2024 · The team that started AIS",
    team: [
