        ...
        <Card className="h-full overflow-hidden hover:border-crimson-200 hover:shadow-[var(--shadow-strong)] transition-shadow">
          <CardBody className="!p-6 h-full flex flex-col">
            <div className="flex items-start justify-between gap-3">
              ...
              {venture.url && (
                <ArrowUpRight className="h-4 w-4 text-charcoal-400 group-hover:text-crimson-700 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 shrink-0" />
              )}
            </div>
            <p className="mt-3 text-sm text-charcoal-600 leading-relaxed flex-1">
              {venture.description}
            </p>
            <div className="mt-4">
