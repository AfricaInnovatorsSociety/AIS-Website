  ...
  return (
    <Section className="!py-16 md:!py-20">
      <div className="rounded-3xl overflow-hidden gradient-brand text-white p-1 shadow-[var(--shadow-strong)]">
        <div className="rounded-[calc(1.5rem-2px)] bg-charcoal-950 p-8 md:p-12 lg:p-14">
          <div className="grid lg:grid-cols-[1.4fr_1fr] gap-10 lg:gap-16 items-end">
            ...
            <div className="flex flex-col gap-3 lg:items-end">
              ...
              <Link
                href={`/events/${slug}`}
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-white hover:text-amber-soft transition-colors"
              >
                Event details
