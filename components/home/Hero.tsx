...
import { FloatingBlob } from "@/components/motion/Motion";
...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-12 pb-20 md:pt-20 md:pb-28">
      {/* Background ornaments — animated floating blobs + dot grid */}
      ...
      {/* Decorative orbit accent (top-right) — hidden on small screens */}
      <motion.div
        className="hidden xl:block absolute right-12 top-24 pointer-events-none"
      ...
      <div className="container-page">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white border border-charcoal-100 px-3.5 py-1.5 text-xs font-semibold text-charcoal-700 shadow-[var(--shadow-soft)] mb-6"
          >
            <motion.span
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.span
                aria-hidden
                className="absolute inset-x-0 bottom-1 md:bottom-2 h-3 md:h-4 bg-amber-soft/40 -z-0 rounded-sm origin-left"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
          ...
          <motion.p
            ...
            className="mt-6 text-lg md:text-xl text-charcoal-600 max-w-2xl leading-relaxed text-pretty"
          >
          ...
          <motion.div
            ...
            className="mt-12 flex items-center gap-6 text-sm text-charcoal-500"
          >
      ...
      <motion.div
        aria-hidden
        className="absolute bottom-6 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 text-charcoal-400 text-xs font-medium"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <motion.div
          className="h-9 w-[2px] rounded-full bg-gradient-to-b from-crimson-700 to-transparent"
